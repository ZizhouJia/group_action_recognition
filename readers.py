...
# copy from https://github.com/google/youtube-8m/blob/master/readers.py
# usage:
# readers.YT8MFrameFeatureReader(feature_names=feature_names, feature_sizes=feature_sizes)
