...
lib_path = "/home/liuchang/y8_torch/libsndfile.so.1"
f_exist = _os.path.exists(lib_path)
print('f_exist ' + str(f_exist))
_snd = _ffi.dlopen(lib_path)
    # _snd = _ffi.dlopen(_libname)
    # with open('snd_file','wb') as f:
    #     dill.dump(_snd,f)

    # if not _os.path.exists('snd_file'):
    #     s_nd = dill.load(open('snd_file'))
#
# except OSError:
